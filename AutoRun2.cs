...
public class AutoRun2 : Node
{
    ...
    public MoveTask StartRun(Machine machine)
    {
        ...
        var runAutoFeed = MoveTask.Create("Run Auto Feed Panel", (p) =>
        {
            switch (p.Step)
            {
                case MoveTask.ENTER:
        ...
        var runFeedPanel = MoveTask.Create("Run Feed Panel", (p) =>
        {
            switch (p.Step)
            {
                case MoveTask.ENTER:
